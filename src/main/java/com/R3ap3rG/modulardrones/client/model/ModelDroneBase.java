...
public class ModelDroneBase extends ModelBase
{
  ...
  public ModelDroneBase()
  {
    ...
    LightBase = new ModelRenderer(this, 0, 19);
    ...
    LightLeft = new ModelRenderer(this, 10, 10);
    ...
    LightRight = new ModelRenderer(this, 10, 10);
    ...
    CntrStrutVert = new ModelRenderer(this, 2, 0);
    CntrStrutVert.addBox(0F, 0F, 0F, 2, 1, 3);
    CntrStrutVert.setRotationPoint(-1F, 11F, 3F);
    CntrStrutVert.setTextureSize(64, 32);
    CntrStrutVert.mirror = true;
    setRotation(CntrStrutVert, 1.570796F, 1.570796F, 0F);
    CntrStrutHrzn = new ModelRenderer(this, 1, 4);
    ...
    BodyVert = new ModelRenderer(this, 13, 0);
    ...
    BodyHrzn = new ModelRenderer(this, 14, 9);
